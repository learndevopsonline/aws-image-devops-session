...
## Uptime
curl -s https://raw.githubusercontent.com/linuxautomations/aws-image-devops-session/master/centos-9/scripts/tuptime >/bin/tuptime
chmod +x /bin/tuptime
...
cp /home/ec2-user/aws-image-devops-session/centos-9/scripts /etc/motd
